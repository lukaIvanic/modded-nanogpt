...
RUN_ID='prime_h100_smoke_debug_20260211T230112Z'
REMOTE_BASE='/home/ubuntu/projects/nanogpt-speedrun'
REPO='/home/ubuntu/projects/nanogpt-speedrun/modded-nanogpt'
RUN_DIR='/home/ubuntu/projects/nanogpt-speedrun/runs/prime_h100_smoke_debug_20260211T230112Z'
...
if [[ -n '8192,8192,8192' ]]; then export TRAIN_BS_SCHEDULE='8192,8192,8192'; fi
if [[ -n '8192' ]]; then export TRAIN_BS_EXTENSION='8192'; fi
if [[ -n '2048' ]]; then export TRAIN_MAX_SEQ_LEN='2048'; fi
if [[ -n '8192' ]]; then export VAL_BATCH_SIZE='8192'; fi
if [[ -n '65536' ]]; then export VAL_TOKENS='65536'; fi
